...
export const ENTITY_TYPE_OPTIONS: EntityTypeOption[] = [
  ...
  { value: 'pickup_laser_focus', label: 'Heat Unlock', color: 0xffa24d },
  { value: 'pickup_laser_spin', label: 'Spin Laser Unlock', color: 0xff6fe5 },
  ...
  { value: 'enemy_spinner_excalibur', label: 'Enemy Spinner Excalibur', color: 0xb9ffc8 },
